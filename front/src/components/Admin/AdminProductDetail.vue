<template>
  <div v-if="product" class="product-detail container my-5">
    <div class="row g-5">
      <div class="col-lg-6">
      ...
      <div class="col-lg-6">
        <div class="card-body">
          <h1 class="card-title display-4">{{ product.name }}</h1>
  ...
  methods: {
    ...
    addToCartHandler() {
      if (!this.isAuthenticated) {
        ...
        console.log("Adding to cart: ", this.product._id);
        this.addToCart({ productId: this.product._id, quantity: 1 });
      }
    },
